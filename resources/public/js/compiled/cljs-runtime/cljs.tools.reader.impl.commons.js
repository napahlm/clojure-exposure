...
var G__13210 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__13210;
continue;
} else {
return ch;
...
var vec__13178 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13178,(0),null);
return (match === s);
});
...
var len__5769__auto___13235 = arguments.length;
var i__5770__auto___13237 = (0);
while(true){
if((i__5770__auto___13237 < len__5769__auto___13235)){
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq13195){
...
return (function() { 
var G__13242__delegate = function (rdr,_){
...
var G__13242 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__13249__i = 0, G__13249__a = new Array(arguments.length -  1);
while (G__13249__i < G__13249__a.length) {G__13249__a[G__13249__i] = arguments[G__13249__i + 1]; ++G__13249__i;}
  _ = new cljs.core.IndexedSeq(G__13249__a,0,null);
} 
return G__13242__delegate.call(this,rdr,_);};
G__13242.cljs$lang$maxFixedArity = 1;
G__13242.cljs$lang$applyTo = (function (arglist__13250){
var rdr = cljs.core.first(arglist__13250);
var _ = cljs.core.rest(arglist__13250);
return G__13242__delegate(rdr,_);
});
