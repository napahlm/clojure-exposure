...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12865 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12865(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12872 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12872(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12875 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12875(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12879 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12879(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12886 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12886(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12889 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12889(reader);
}
});
...
var G__13019 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13020 = s.append(c);
c = G__13019;
s = G__13020;
continue;
}
