...
var temp__5802__auto____$1 = (o11839["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o11840 = temp__5802__auto____$1;
return (o11840["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11497__auto__ = f;
return (o__11497__auto__["toString"]).call(o__11497__auto__);
} else {
return "";
}
}catch (e11848){var _ = e11848;
return "";
}});
...
try{var o__11497__auto___12544 = t;
(o__11497__auto___12544["cljs$lang$ctorPrWriter"]).call(o__11497__auto___12544,t,writer);
}catch (e11871){var __12545 = e11871;
}
...
var char_code = (function (){var o__11497__auto__ = (new String(char$));
return (o__11497__auto__["charCodeAt"]).call(o__11497__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11497__auto__ = String;
return (o__11497__auto__["fromCharCode"]).call(o__11497__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11912 = num_code;
switch (G__11912) {
case (1):
return (185);
...
var o__11497__auto__ = String;
return (o__11497__auto__["fromCharCode"]).call(o__11497__auto__,superscript_code);
});
/**
...
}catch (e11969){var _e__11532__auto__ = e11969;
return false;
}})())){
...
var vec__11973 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11973,(0),null);
...
var G__12565 = (i__5770__auto___12560 + (1));
i__5770__auto___12560 = G__12565;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12048){
var vec__12049 = p__12048;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12049,(0),null);
...
var G__12568 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12569 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12568;
remaining_tokens = G__12569;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12037){
var G__12038 = cljs.core.first(seq12037);
var seq12037__$1 = cljs.core.next(seq12037);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12038,seq12037__$1);
}));
...
var vec__12103 = cljs.core.split_with((function (p1__12090_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12090_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12103,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12103,(1),null);
...
var vec__12138 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12138,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12138,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12582 = cljs.core.rest(remaining_tokens);
var G__12584 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12582;
name_tokens = G__12584;
continue;
} else {
...
var vec__12170 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12170,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12170,(1),null);
var vec__12173 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12173,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12173,(1),null);
var vec__12176 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12176,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12176,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12176,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12176,(3),null);
...
var vec__12205 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12205,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12205,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12205,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12205,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12205,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12205,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12217 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12217,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12217,(1),null);
var vec__12225 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12225,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12225,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12244 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12244) : devtools.munging.parse_fn_info_deep.call(null,G__12244));
})()));
}
} else {
return fn_info;
...
var G__12620 = (arity + (1));
var G__12621 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12297){
var vec__12298 = p__12297;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12298,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12298,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12328_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12328_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12329_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12329_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12353){
var vec__12355 = p__12353;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12355,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12343){
...
var map__12460 = options;
var map__12460__$1 = cljs.core.__destructure_map(map__12460);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12460__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12460__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12460__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12460__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12461 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12461,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12461,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12461,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12461,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12461,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12461,(5),null);
...
var o__11497__auto__ = f;
return (o__11497__auto__["getBasis"]).call(o__11497__auto__);
});
/**
...
}catch (e12484){var _e__11532__auto__ = e12484;
...
var G__12648 = (obj[cljs.core.first(path)]);
var G__12649 = cljs.core.rest(path);
obj = G__12648;
path = G__12649;
continue;
} else {
...
var _STAR_ = (function (accum,p__12504){
var vec__12505 = p__12504;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12505,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12505,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12508){
var vec__12509 = p__12508;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12509,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12509,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12509,(2),null);
...
var post_process = (function (p__12529){
var vec__12530 = p__12529;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12530,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12530,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12523_SHARP_){
return (obj[cljs.core.first(p1__12523_SHARP_)]);
}),sorted_matches);
