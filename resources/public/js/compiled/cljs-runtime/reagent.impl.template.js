...
var G__21613 = o;
reagent.impl.template.goog$module$goog$object.set(G__21613,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__21921__delegate = function (args){
...
while (G__21922__i < G__21922__a.length) {G__21922__a[G__21922__i] = arguments[G__21922__i + 0]; ++G__21922__i;}
  args = new cljs.core.IndexedSeq(G__21922__a,0,null);
} 
return G__21921__delegate.call(this,args);};
...
return G__21921__delegate(args);
});
...
var G__21632 = o;
reagent.impl.template.goog$module$goog$object.set(G__21632,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__21927__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__21928__i < G__21928__a.length) {G__21928__a[G__21928__i] = arguments[G__21928__i + 0]; ++G__21928__i;}
  args = new cljs.core.IndexedSeq(G__21928__a,0,null);
} 
...
var args = cljs.core.seq(arglist__21929);
...
var G__21639 = props;
var G__21639__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21639,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21639);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21639__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21650 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21650,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21650;
}
})(),id_class);
...
var G__21658 = (cljs.core.count(argv) - first_child);
switch (G__21658) {
case (0):
...
var vec__21674 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21674,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21674,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21674,(2),null);
...
var temp__5808__auto___21939 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21939 == null)){
} else {
var key_21940 = temp__5808__auto___21939;
(jsprops.key = key_21940);
}
...
var temp__5808__auto___21941 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21941 == null)){
} else {
var key_21942 = temp__5808__auto___21941;
(jsprops.key = key_21942);
}
...
var temp__5808__auto___21944 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___21944 == null)){
} else {
var key_21945 = temp__5808__auto___21944;
(jsprops.key = key_21945);
}
...
var temp__5808__auto___21958 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21958 == null)){
} else {
var key_21960 = temp__5808__auto___21958;
(jsprops.key = key_21960);
}
...
var temp__5808__auto___21970 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21830_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21830_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21838 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21838,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21838,(1),null);
...
break;
default:
var G__21979 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21980 = compiler;
v = G__21979;
compiler = G__21980;
continue;
...
var G__21872 = tag;
var G__21872__$1 = (((G__21872 instanceof cljs.core.Keyword))?G__21872.fqn:null);
switch (G__21872__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template21897 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template21897 = (function (opts,id,fn_to_element,parse_fn,meta21898){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21897.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21899,meta21898__$1){
var self__ = this;
var _21899__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21897(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21898__$1));
}));

(reagent.impl.template.t_reagent$impl$template21897.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21899){
var self__ = this;
var _21899__$1 = this;
return self__.meta21898;
}));

(reagent.impl.template.t_reagent$impl$template21897.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21897.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21897.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21897.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21897.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21897.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21898","meta21898",628289233,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21897.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21897.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21897");

(reagent.impl.template.t_reagent$impl$template21897.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template21897");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21897.
 */
reagent.impl.template.__GT_t_reagent$impl$template21897 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template21897(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21898){
return (new reagent.impl.template.t_reagent$impl$template21897(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21898));
});

}

return (new reagent.impl.template.t_reagent$impl$template21897(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
